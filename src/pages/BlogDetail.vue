<template>
    <div>
        <page-header bg="dist/img/post-bg.jpg" title="Man must explore, and this is exploration at its greatest" subHeading="roblems look mighty small from 150 miles up" className="post-heading">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-10 mx-auto">
                        ...
                        <a href="#">
                            <img class="img-fluid" src="/dist/img/post-sample-image.jpg" alt="">
                        </a>
